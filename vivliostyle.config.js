module.exports = {
  title: 'miura', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'ogwata@vivliostyle.org <ogwata@vivliostyle.org>', // default to `author` in `package.json` or undefined.
